...
public class BankTest {
    ...
    class EconomyCreditOfferTest {
        ...
        class RegularCustomer {
            ...
            public void testEconomyCreditOfferRegularCustomer() {
                assertAll("Verify all conditions for a regular customer and an economy credit offer",
    ...
    class BusinessCreditOfferTest {
        ...
        class RegularCustomer {
            ...
            public void testBusinessCreditOfferRegularCustomer() {
                assertAll("Verify all conditions for a regular customer and a business credit offer",
